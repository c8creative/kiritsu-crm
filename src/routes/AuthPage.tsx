  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-whiten dark:bg-boxdark-2">
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark w-full max-w-[420px] p-8 sm:p-10">
        <h2 className="mb-2 text-2xl font-bold font-nunito text-black dark:text-white sm:text-title-xl2">
          Kiritsu CRM
        </h2>
        <p className="mb-6 font-medium text-body-color dark:text-bodydark">
          Traditional Discipline. Modern Precision.
        </p>
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className="mb-5">
            <button
              ...
              disabled={busy}
            >
              {busy ? (isSignUp ? 'Creating account…' : 'Signing in…') : (isSignUp ? 'Create Account' : 'Sign in with Email')}
            </button>
          </div>
        </form>
        ...
        <div className="mt-4 text-center">
          <p className="text-sm font-medium text-body-color dark:text-bodydark italic">
            Kiritsu CRM - Traditional Discipline. Modern Precision.
          </p>
        </div>
      </div>
    </div>
